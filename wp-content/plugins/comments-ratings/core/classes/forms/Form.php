 ...
 */
class PixReviewsFormImpl extends PixReviewsHTMLElementImpl implements PixReviewsForm {
	...
	protected function configure($config = null) {
		...
		$this->autocomplete = pixreviews::instance('PixReviewsMeta', array());

		// setup fields
		$this->fields = pixreviews::instance('PixReviewsMeta', $config['fields']);
		unset($config['fields']);
	...
	function field($fieldname, $fieldconfig = null) {
		...
		return pixreviews::instance('PixReviewsFormField', $fieldconfig)
			->setmeta('form', $this)
	...
	/** @var PixReviewsMeta autocomplete */
	protected $autocomplete = null;

	/**
	 * Autocomplete meta object passed on by the processor.
	 *
	 * @param PixReviewsMeta autocomplete values
	 * @return static $this
	 */
	function autocomplete(PixReviewsMeta $autocomplete) {
	...
	/**
	 * @param string template path
	 * @param PixReviewsMeta configuration
	 * @return string
	 */
	protected function fieldtemplate_render($_template_path, PixReviewsMeta $conf) {
