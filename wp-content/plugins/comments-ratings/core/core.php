...
class pixreviews {
	 ...
	 * @return PixReviewsForm
	 */
	static function form($config, $processor) {
		$form = self::instance('PixReviewsForm', $config);
	...
	/**
	 * @param array configuration
	 * @return PixReviewsProcessor
	 */
	static function processor($config) {
		return self::instance('PixReviewsProcessor', $config);
	}
	 ...
	 * @throws Exception
	 */
	static function callback($key, PixReviewsMeta $meta) {
