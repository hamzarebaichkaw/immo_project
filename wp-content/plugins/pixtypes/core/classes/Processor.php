 ...
 */
class PixtypesProcessorImpl implements PixtypesProcessor {
	...
	/** @var PixtypesMeta current data; including submitted data */
	protected $data = null;
	...
	protected function load_data_from_database($option_key) {
		...
		$this->data = pixtypes::instance('PixtypesMeta', $dbconfig);
	}
	...
	protected function validate_input($input) {
		$validator = pixtypes::instance('PixtypesValidator', $this->meta, $this->fields);
