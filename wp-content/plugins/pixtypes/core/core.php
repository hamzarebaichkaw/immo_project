...
class pixtypes {
	...
	static function form($config, $processor) {
		$form = self::instance('PixtypesForm', $config);
	...
	/**
	 * @param array configuration
	 * @return PixtypesProcessor
	 */
	static function processor($config) {
		return self::instance('PixtypesProcessor', $config);
	}
	 ...
	 * @throws Exception
	 */
	static function callback($key, PixtypesMeta $meta) {
