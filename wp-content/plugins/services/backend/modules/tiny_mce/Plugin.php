...
class Plugin
{
    ...
    public function addButton( $buttons )
    {
      ...
      /*  if ( $version < 3.5 ) {
            ...
            echo '<a href="#TB_inline?width=640&inlineId=ab-tinymce-popup&height=650" id="add-bookly-form" title="' . esc_attr__( 'Add Bookly booking form', 'bookly' ) . '">' . __( 'Add services booking form', 'bookly' ) . '</a>';
