                    ...
                    <div class="panel-body">
                        <form method="post">
                            ...
                            <div class="row">
                                <div class="col-md-9 col-sm-6">
                                    <div class="form-group">
                                        <label for="title_<?php echo $service_id ?>"><?php _e( 'Titre', 'bookly' ) ?></label>
                                        <input name="title" id="title_<?php echo $service_id ?>" class="form-control" type="text">
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group">
                                        <label><?php _e( 'Couleur', 'bookly' ) ?></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="price_<?php echo $service_id ?>"><?php _e( 'Prix', 'bookly' ) ?></label>
                                ...
                                <div class="col-sm-4 ab--for-simple">
                                    <div class="form-group">
                                        <label for="capacity_<?php echo $service_id ?>"><?php _e( 'Capacité', 'bookly' ) ?></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 ab--for-simple">
                                    <div class="form-group">
                                        <label><?php _e( 'fournisseur ', 'bookly' ) ?></label><br>
                                        <div class="btn-group">
                                                ...
                                                <li>
                                                    <a class="checkbox" href="javascript:void(0)">
                                                        <label>
                                                            ...
                                                            <?php _e( 'l`equipe technique', 'bookly' ) ?>
                                                        </label>
                                                    </a>
                                                </li>
                            ...
                            <div class="form-group">
                                <label for="info_<?php echo $service_id ?>">
                                    <?php _e( 'Pour plus des information', 'bookly' ) ?>
                                </label>
                                <p class="help-block">
                                    <?php printf( __( 'Ce texte peut être inséré dans les notifications %s code.', 'bookly' ), '{service_info}' ) ?>
                                </p>
                            ...
                            <div class="panel-footer">
                                ...
                                <button %s type="submit" class="btn btn-lg btn-success ladda-button %s" data-style="zoom-in" data-spinner-size="40"><span class="ladda-label">sauvgarder</span> <?php  register_activation_hook( __FILE__, 'add_new_service' ); ?></button>
