...
add_action('admin_menu','aplugin1_admin_actions');
function aplugin1_admin_actions(){
    add_options_page('Services host','Services host','manage_options',_FILE_,'aplugin1_admin');
}
function aplugin1_admin()
{?>
                ...
                <div id="bookly-categories-list" class="bookly-nav">
                    <div class="bookly-nav-item active bookly-category-item bookly-js-all-services">
                     ...
                     <ul id="bookly-category-item-list">
                        <?php //sforeach ( $category_collection as $category ) include '_category_item.php'; ?>
                    </ul>
                </div>
...
function admin_js_services() {

$admin_handle = 'admin_js_services';
$admin_script = plugin_dir_url( __FILE__ ) . '/js/services_host_js.js';

wp_enqueue_script( $admin_handle, $admin_script );
}
add_action('admin_print_script', 'admin_js_services');

function admin_css() {

$admin_handle = 'admin_css';
$admin_stylesheet = plugin_dir_url( __FILE__ ) . '/css/forms.css';
